...
class AppTextStyle {
  ...
  static TextStyle _regular(double size, Color color, {bool isUnderline = false}) {
    return TextStyle(
  ...
  static TextStyle regular10(Color color, {bool isUnderline = false}) {
    return _regular(10, color, isUnderline: isUnderline);
  }

  static TextStyle regular11(Color color, {bool isUnderline = false}) {
    return _regular(11, color, isUnderline: isUnderline);
  }

  static TextStyle regular12(Color color, {bool isUnderline = false}) {
    return _regular(12, color, isUnderline: isUnderline);
  }

  static TextStyle regular13(Color color, {bool isUnderline = false}) {
    return _regular(13, color, isUnderline: isUnderline);
  }

  static TextStyle regular14(Color color, {bool isUnderline = false}) {
    return _regular(14, color, isUnderline: isUnderline);
  }

  static TextStyle regular15(Color color, {bool isUnderline = false}) {
    return _regular(15, color, isUnderline: isUnderline);
  }

  static TextStyle regular16(Color color, {bool isUnderline = false}) {
    return _regular(16, color, isUnderline: isUnderline);
  }

  static TextStyle regular17(Color color, {bool isUnderline = false}) {
    return _regular(17, color, isUnderline: isUnderline);
  }

  static TextStyle regular18(Color color, {bool isUnderline = false}) {
    return _regular(18, color, isUnderline: isUnderline);
  }

  static TextStyle regular19(Color color, {bool isUnderline = false}) {
    return _regular(19, color, isUnderline: isUnderline);
  }

  static TextStyle regular20(Color color, {bool isUnderline = false}) {
    return _regular(20, color, isUnderline: isUnderline);
  }

  static TextStyle regular21(Color color, {bool isUnderline = false}) {
    return _regular(21, color, isUnderline: isUnderline);
  }

  static TextStyle regular22(Color color, {bool isUnderline = false}) {
    return _regular(22, color, isUnderline: isUnderline);
  }

  static TextStyle regular23(Color color, {bool isUnderline = false}) {
    return _regular(23, color, isUnderline: isUnderline);
  }

  static TextStyle regular24(Color color, {bool isUnderline = false}) {
    return _regular(24, color, isUnderline: isUnderline);
  }

  static TextStyle regular25(Color color, {bool isUnderline = false}) {
    return _regular(25, color, isUnderline: isUnderline);
  }

  static TextStyle regular26(Color color, {bool isUnderline = false}) {
    return _regular(26, color, isUnderline: isUnderline);
  }

  static TextStyle regular27(Color color, {bool isUnderline = false}) {
    return _regular(27, color, isUnderline: isUnderline);
  }

  static TextStyle regular28(Color color, {bool isUnderline = false}) {
    return _regular(28, color, isUnderline: isUnderline);
  }

  static TextStyle regular29(Color color, {bool isUnderline = false}) {
    return _regular(29, color, isUnderline: isUnderline);
  }

  static TextStyle regular30(Color color, {bool isUnderline = false}) {
    return _regular(30, color, isUnderline: isUnderline);
  }

  static TextStyle regular31(Color color, {bool isUnderline = false}) {
    return _regular(31, color, isUnderline: isUnderline);
  }

  static TextStyle regular32(Color color, {bool isUnderline = false}) {
    return _regular(32, color, isUnderline: isUnderline);
  }
